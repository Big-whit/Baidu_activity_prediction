...
def load_data(past_day, future_day, data_name, data_type, data_dilution_ratio, data_path):
    ...
    # Remove the previous day + future Inactive users in day
...
def getDataLoader(batch_size=32, params={}, data_name='KDD', data_path='./data/Kwai', data_type=""):
    past_day = params['day']
    ...
    if os.path.exists(save_path_pre + l[0] + save_path_last + '.pt'):
        ...
        draw_day_action_num(y, future_day, params_load["a_feat_size"], data_name)
        ...
        draw_day_action_num(y, future_day, params["a_feat_size"], data_name)
...
def draw_day_action_num(y, future_day, a_feat_size, data_name):
